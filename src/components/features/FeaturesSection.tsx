    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20 text-center mx-auto">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight">
          Tournament Control
          <br />
          <span className="text-gradient font-medium">Modules & Flows</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400">
          Orchestrate schedules, brackets, crews, and live scoring with the same responsive system Indian federations and leagues rely on every weekend.
        </p>
      </div>
